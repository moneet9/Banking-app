...
import { applyLoan } from '../services/bankingApi';

const loanTypes = [
  { value: 'personal', label: 'Personal Loan', rate: 8.5 },
  { value: 'home', label: 'Home Loan', rate: 6.5 },
  { value: 'auto', label: 'Auto Loan', rate: 7.2 },
  { value: 'business', label: 'Business Loan', rate: 9.5 },
];
...
export default function Loans() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await applyLoan({
        loanType: loanType as 'personal' | 'home' | 'auto' | 'business',
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        {/* Info Card */}
        <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200 rounded-2xl p-4 mb-6">
          <div className="flex gap-3">
            <Info className="w-5 h-5 text-[#0066FF] mt-0.5 flex-shrink-0" />
            <div>
              <p className="text-sm font-medium text-[#0066FF] mb-1">Quick & Easy Approval</p>
        ...
        <Card className="bg-white rounded-3xl shadow-xl p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex gap-2 mt-2">
                {amountPresets.map((preset) => (
                  <button
                    ...
                    className="px-3 py-2 bg-blue-50 text-[#0066FF] rounded-lg text-xs font-medium hover:bg-blue-100 transition-colors"
                  >
                    ₹{preset.label}
                  </button>
                ))}
            ...
            <Card className="bg-gradient-to-br from-purple-50 to-blue-50 border-purple-200 rounded-2xl p-4">
            ...
            <div className="bg-blue-50 rounded-2xl p-4 space-y-3">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-[#0066FF] text-lg">₹{parseFloat(monthlyPayment).toLocaleString('en-IN')}</span>
                </div>
              </div>
            </div>
